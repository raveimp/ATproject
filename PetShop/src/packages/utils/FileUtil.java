...
public class FileUtil {
    ...
    public static void writeFile(String path, String content) {                                                          //создаем метод writeFile для записи в файл
        try (OutputStreamWriter writer = new OutputStreamWriter(new FileOutputSrteam(path), StandardCharsets.UTF_8)) {   //создаем переменную класса OutputStreamWriter для конвертирования символов в байты и записи в файл?
